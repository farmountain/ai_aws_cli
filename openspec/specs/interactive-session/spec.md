# Capability: interactive-session

## Purpose

Provide both stateless single-command invocation and a stateful interactive REPL session with bounded conversation context for multi-turn AWS operations.
