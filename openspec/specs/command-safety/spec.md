# Capability: command-safety

## Purpose

Classify AWS CLI commands by risk tier and enforce safety gates (confirmation prompts, warnings, refusals) before execution to prevent accidental destructive operations.
